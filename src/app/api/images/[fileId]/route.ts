 ...
 * It's only available when running the site with a Node.js server.
 * For static deployments, use the 'local' or 'directGoogleDrive' image providers.
 */

// This route requires a server and cannot be statically exported
