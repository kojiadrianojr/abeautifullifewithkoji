    ...
    >
      <Container maxW="3xl">
        <VStack spacing={8}>
          ...
          <Text fontSize={{ base: 'xl', md: '2xl' }} textAlign="center" fontWeight={400}>
            {rsvp.message}
          </Text>
          ...
          <Link href={rsvp.formUrl} target="_blank" rel="noopener noreferrer" _hover={{ textDecoration: 'none' }}>
            <AnimatedButton
              size="lg"
              colorScheme="white"
              variant="solid"
